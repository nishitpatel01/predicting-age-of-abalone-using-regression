---
title: "Data Analysis Project Proposal - Predicting the age of abalone"
date: "July 15, 2017"
output:
  html_document: 
    toc: yes
...
- **Apply different regression techniques:**
    - We are interested in performing various regression techniques such as additive models, interactions, polynomial transformations of the variables etc to be able to predict the age of abalone and assess the accuracy of our prediction.
